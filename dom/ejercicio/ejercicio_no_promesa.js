function inic(numPages)
{
    ...
    xhttp.onreadystatechange = function ()
    {
        ...
        let url=`https://dummyapi.io/data/v1/user?page=${numPages}&limit=${numUsers}`;
...
function ListaUsers (contenido)
{
    ...
    {
        let lista_users=document.getElementById("list_users");
        ...
        {
            lista_users.innerHTML +=` 
            <li><img src="${item.picture}" width="100px" align="center"> ${item.title} ${item.firstName} ${item.lastName}
